...
//		}   
	...
	//	}
       ...
       // opexNONITprior = Double.parseDouble(val_cost[81])
		...
		opexNONIT1 = Double.parseDouble(val_cost[50]) +Double.parseDouble(val_cost[68]);        opexNONIT2 = Double.parseDouble(val_cost[51]) +Double.parseDouble(val_cost[69]);
        opexNONIT3 = Double.parseDouble(val_cost[52]) +Double.parseDouble(val_cost[70]);        opexNONIT4 = Double.parseDouble(val_cost[53]) +Double.parseDouble(val_cost[71]);
        opexNONIT5 = Double.parseDouble(val_cost[54]) +Double.parseDouble(val_cost[72]);      //  opexNONITT = Double.parseDouble(val_cost[55]) +Double.parseDouble(val_cost[73]);
